...
var ctf_methods = function() {
      ...
      var totaldots = ctf_variables.flagrunners.length + ctf_variables.attackers.length;
      ...
      this.drawFlags = function() {
         ctf_variables.flags.forEach(function(element, index, array) {
            var img = new Image();
            img.src = ctf_variables.flags[index].src;
            ctf_constants.ctx.drawImage(img, ctf_variables.flags[index].x, ctf_variables.flags[index].y);
         });
      }
