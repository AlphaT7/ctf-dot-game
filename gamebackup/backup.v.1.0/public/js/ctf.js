/* global $ socket gameroom */
            ...
            function drawGoalBoundries() {
               ...
               goalboundries.forEach(function(element,index,array){
                  ...
                  if (attackers.length > 0 && index == 0){
                     for(var i = 0; i < attackers.length; i++){
                        ...
                        if (test){
                           ...
                           totaldots --;
                           $('#attackercount').html('Attackers: ' + attackers.length);
                        }
                     }
                  }
                  ...
                  if (eattackers.length > 0 && index == 1) {
                     for(var i = 0; i < eattackers.length; i++){
                        var test = RectCircleColliding(eattackers[i],element) ==  true;
            ...
            canvas.oncontextmenu = function(e){
               ...
               if (gamelive == 1) {
                  if (totaldots < 10) {
                     ...
                     ctx.rect(dropboundry.x, dropboundry.y, dropboundry.w, dropboundry.h);
                     if (ctx.isPointInPath(mouse.x, mouse.y) == false){
                        drawNewCircle(x,y,7,colors.blue,'flagrunners')
                        $('#flagrunnercount').html('Flagrunners: ' + flagrunners.length)
                        totaldots ++;
                     }
                  } else {
                     message ('You have reached your dot limit of 10!')
                  }
               } else { message ("You have not setup your game yet.") }
            };
            ...
            canvas.addEventListener('click',function(e){
               if (gamelive == 1){
                  if (totaldots < 10) {
                     ...
                     ctx.rect(dropboundry.x, dropboundry.y, dropboundry.w, dropboundry.h);
                     if (ctx.isPointInPath(mouse.x, mouse.y) == false) {
                        drawNewCircle(x,y,7,colors.blue,'attackers')
                        $('#attackercount').html('Attackers: ' + attackers.length)
                        totaldots ++;
                     }
                  } else {
